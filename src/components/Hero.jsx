    ...
    <header id="hero" className="container hero">
      <div>
        <div className="hero__badge">
          ...
          <span className="hero__badge-text">HACCP 인증 · 고춧가루 전문 제조기업</span>
        </div>
        ...
        <p className="hero__desc">
          두나팜은 고추 수입부터 건조, 분쇄, 제조, 포장까지 전 공정을 직접 관리하며, HACCP
          기준에 맞춘 체계적인 생산 시스템으로 신뢰할 수 있는 고춧가루를 공급합니다.
        </p>
      ...
      <div className="hero__visual">
        <div className="hero__image-frame">
          ...
          <img src="/assets/hero-product.jpg" alt="두나팜 고춧가루 제품" />
        </div>
      </div>
    </header>
  );
